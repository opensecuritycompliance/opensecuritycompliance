...
const CredentialYAML = `# This file is autogenerated. Modify as per your task needs.

apiVersion: v1alpha1
kind: credentialType
meta:
  name: {{CREDENTIAL_CLASS_NAME}} # <name of the credential type. Examples, activeDirectory> only alpha
  displayName:  {{CREDENTIAL_CLASS_NAME}} # <optional. How do you want this to show up in the ComplianceCow UI. Example, Active Directory> 
  version: {{CREDENTIAL_VERSION}} # optional. semver
spec:
 extends: [] # optional. The attributes section will add to the extended attributes
 attributes:
 - name: attributeName #Attribute Name -  only alpha
   ...
   dataType: STRING # data type of the attribute.  Available Types STRING, INT, FLOAT, FILE
