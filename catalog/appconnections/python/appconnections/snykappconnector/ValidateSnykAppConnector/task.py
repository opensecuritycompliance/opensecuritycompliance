...
import snykappconnector

from typing import overload
from compliancecowcards.structs import cards, cowvo
import json

class ValidateSnykAppConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        snykappconnector_obj = snykappconnector.SnykAppConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = snykappconnector_obj.validate()
