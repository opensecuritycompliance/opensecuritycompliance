...
import servicenowconnector
import json

class ValidateServiceNowConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        servicenowconnector_obj = servicenowconnector.ServiceNowConnector.from_dict(
            user_defined_credentials)

        is_valid, validation_message = servicenowconnector_obj.validate()
