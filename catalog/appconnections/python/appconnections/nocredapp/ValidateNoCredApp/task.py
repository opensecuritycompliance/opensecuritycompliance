...
class ValidateNoCredApp(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        nocredapp_obj = nocredapp.NoCredApp.from_dict(user_defined_credentials)

        is_valid, validation_message = nocredapp_obj.validate()
