...
class ValidateKubernetes(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        kubernetes_obj = kubernetes.Kubernetes.from_dict(user_defined_credentials)
        is_valid, validation_message = kubernetes_obj.validate()
