...
import privacybisonconnector

from typing import overload
from compliancecowcards.structs import cards, cowvo
import json

class ValidatePrivacyBisonConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        privacybisonconnector_obj = privacybisonconnector.PrivacyBisonConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = privacybisonconnector_obj.validate()
