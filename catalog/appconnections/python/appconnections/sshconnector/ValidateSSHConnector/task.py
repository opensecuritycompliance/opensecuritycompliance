...
class ValidateSSHConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        sshconnector_obj = sshconnector.SSHConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = sshconnector_obj.validate()
