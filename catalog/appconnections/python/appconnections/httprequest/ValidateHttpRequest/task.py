...
class ValidateHttpRequest(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        httprequest_obj = httprequest.HttpRequest.from_dict(user_defined_credentials)

        is_valid, validation_message = httprequest_obj.validate()
