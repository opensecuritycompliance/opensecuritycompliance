...
func (thisObj *NoCredApp) GetCompanyNameFromHARFile(file []byte) (string, error) {
	var harfile = &HarVO{}
	siteUrl := ""
...
func (thisObj *NoCredApp) GetEpssScoreForCVE(cveID string) (float64, string, string, error) {
...
func (thisObj *NoCredApp) GetCurrentTime() string {
