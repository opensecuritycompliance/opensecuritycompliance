...
class Task(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        if error:
            log_file_url, error = self.upload_log_file({'error': f'Error while downloading HARFile :: {error}'})
            if error:
                return {'error': error}
            return {"LogFile": log_file_url}
        ...
        for uriWithSriDetails in urisWithSriDetails:
            ...
            urisWithSriDetailsStandardized.append({
                # Meta
                "System": uriWithSriDetails["System"],
                ...
                # Data
                "Integrity": uriWithSriDetails["Integrity"],
