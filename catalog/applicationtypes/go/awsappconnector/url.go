...
const (
	...
	IAM_PASSWORD_POLICY_URL      = "https://console.aws.amazon.com/iamv2/home?#/account_settings"
	...
	EC_INSTANCE_URL              = "https://<<Region>>.console.aws.amazon.com/ec2/home?region=<<Region>>#InstanceDetails:instanceId=<<Resource>>"
	DYNAMO_DB_INSTANCE_URL       = "https://<<Region>>.console.aws.amazon.com/dynamodbv2/home?region=<<Region>>#table?name=<<Resource>>"
	ELASTIC_CACHE_URL            = "https://<<Region>>.console.aws.amazon.com/elasticache/home?region=<<Region>>#/<<ResourceParent>>/<<Resource>>"
	TIMESTREAM_URL               = "https://<<Region>>.console.aws.amazon.com/timestream/home?region=<<Region>>#databases/details?database=<<Resource>>"
	NEPTUNE_URL                  = "https://<<Region>>.console.aws.amazon.com/neptune/home?region=<<Region>>#database-details:id=<<Resource>>"
	DOCDB_URL                    = "https://<<Region>>.console.aws.amazon.com/docdb/home?region=<<Region>>#cluster-details/<<Resource>>"
	QLDB_URL                     = "https://<<Region>>.console.aws.amazon.com/qldb/home?region=<<Region>>#ledger-details/<<Resource>>"
	KEYSPACE_INSTANCE_URL        = "https://<<Region>>.console.aws.amazon.com/keyspaces/home?region=<<Region>>#keyspace?name=<<Resource>>"
	CLOUD_FRONT_DISTRIBUTION_URL = "https://<<Region>>.console.aws.amazon.com/cloudfront/v4/home?region=<<Region>>#/distributions/<<Resource>>"
	DIRECT_CONNECT_URL           = "https://<<Region>>.console.aws.amazon.com/directconnect/v2/home?region=<<Region>>#connections/<<Resource>>"
	ROUTE53_URL                  = "https://<<Region>>.console.aws.amazon.com/route53/v2/hostedzones?region=<<Region>>#ListRecordSets/<<Resource>>"
	NETWORK_FIREWALL_URL         = "https://<<Region>>.console.aws.amazon.com/vpcconsole/home?region=<<Region>>#FirewallDetails:firewallArn=<<Resource>>"
)
