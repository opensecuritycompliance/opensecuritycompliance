...
import salesforceappconnector

from typing import overload
from compliancecowcards.structs import cards, cowvo
import json

class ValidateSalesforceAppConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        salesforceappconnector_obj = salesforceappconnector.SalesforceAppConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = salesforceappconnector_obj.validate()
