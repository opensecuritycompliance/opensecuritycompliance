...
class ValidateGCPConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        gcpconnector_obj = gcpconnector.GCPConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = gcpconnector_obj.validate()
