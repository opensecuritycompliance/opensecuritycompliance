...
import argocdconnector

from typing import overload
from compliancecowcards.structs import cards, cowvo
import json

class ValidateArgoCDConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        argocdconnector_obj = argocdconnector.ArgoCDConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = argocdconnector_obj.validate()
