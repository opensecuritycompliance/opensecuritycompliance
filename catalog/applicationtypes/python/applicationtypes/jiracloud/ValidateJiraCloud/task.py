...
class ValidateJiraCloud(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        jira_obj = jiracloud.JiraCloud.from_dict(user_defined_credentials)

        is_valid, validation_message = jira_obj.validate()
