...
import oktaconnector

from typing import overload
from compliancecowcards.structs import cards, cowvo
import json

class ValidateOktaConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        oktaconnector_obj = oktaconnector.OktaConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = oktaconnector_obj.validate()
