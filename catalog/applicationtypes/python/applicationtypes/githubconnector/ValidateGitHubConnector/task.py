...
class ValidateGitHubConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        github_obj = githubconnector.GitHubConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = github_obj.validate()
