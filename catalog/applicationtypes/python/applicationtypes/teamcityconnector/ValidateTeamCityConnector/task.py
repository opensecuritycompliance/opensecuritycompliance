...
import teamcityconnector

from typing import overload
from compliancecowcards.structs import cards, cowvo
import json

class ValidateTeamCityConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        teamcityconnector_obj = teamcityconnector.TeamCityConnector.from_dict(user_defined_credentials)

        is_valid, validation_message = teamcityconnector_obj.validate()
