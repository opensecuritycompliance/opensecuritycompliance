...
import googleworkspaceappconnector

from typing import overload
from compliancecowcards.structs import cards, cowvo


class ValidateGoogleWorkSpaceAppConnector(cards.AbstractTask):
    ...
    def execute(self) -> dict:
        ...
        googleworkspaceappconnector_obj = googleworkspaceappconnector.GoogleWorkSpaceAppConnector.from_dict(user_defined_credentials)
		
        is_valid, validation_message = googleworkspaceappconnector_obj.validate()
